...
public class LoadingDialogue extends JDialog {
    private JPanel contentPane;
    public JButton buttonOK;

    public LoadingDialogue() {
        setTitle("Diktat Buddy - Ladevorgang");
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("Bitte warten während die Anwendung lädt...");
        panel1.add(label1, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(150, 50), null, 0, false));
